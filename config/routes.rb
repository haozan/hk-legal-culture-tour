...
Rails.application.routes.draw do
  ...
  # Routes for routes generated by controller generator
  resources :routes, only: [:index, :show]
  # End routes for routes

  # Routes for check_in_spots generated by controller generator
  resources :check_in_spots, only: [:index, :show]
  # End routes for check_in_spots
