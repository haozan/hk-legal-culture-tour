...
Rails.application.configure do
  ...
  # Store uploaded files on the cloud storage bucket (S3/GCS) if configured, otherwise use local disk
  if ENV["STORAGE_BUCKET_NAME"].present? && ENV["STORAGE_BUCKET_ACCESS_KEY_ID"].present?
